               ...
               <div class="nano-content">
                  <nav id="menu" class="nav-main" role="navigation">
                     <ul class="nav nav-main">
                        ...
                        <li>
                           <a href="code_generated.php">
                              <i class="fa fa-eye" aria-hidden="true"></i>
                              <span>View Generated Codes</span>
                           </a>
                        </li>
                           ...
                           <div class="panel-body">
                              <div class="widget-summary">
                                 ...
                                 <div class="widget-summary-col">
                                    <div class="summary">
                                       <h4 class="title">Number Of Registered Voters</h4>
                                       <div class="info">
                                          <strong class="amount"><?php  $get_registered_voters = mysqli_query($my_connect,"SELECT * FROM `tbl_voters_list` "); echo $registerd_voters = mysqli_num_rows($get_registered_voters);    ?></strong>
                        ...
                        <section class="panel panel-featured-left panel-featured-secondary">
                           <div class="panel-body">
                              <div class="widget-summary">
                                 ...
                                 <div class="widget-summary-col">
                                    <div class="summary">
                                       <h4 class="title">Number Of Codes Generated</h4>
                                       <div class="info">
                                          <strong class="amount"><?php  $get_codes_registered  = mysqli_query($my_connect,"SELECT * FROM `tbl_voters_list` WHERE `voters_code_allow` = '1' "); echo  mysqli_num_rows($get_codes_registered);    ?> </strong>
                                       </div>
                                    </div>
                                    <div class="summary-footer">
                        ...
                        <section class="panel panel-featured-left panel-featured-tertiary">
                           <div class="panel-body">
                              <div class="widget-summary">
                                 ...
                                 <div class="widget-summary-col">
                                    <div class="summary">
                                       <h4 class="title">Number Of People Voted</h4>
                                       <div class="info">
                                          <strong class="amount"><?php   $get_votted_users = mysqli_query($my_connect,"SELECT * FROM `voters_voting_pool` WHERE pool_voted = '1'"); echo  mysqli_num_rows($get_votted_users);    ?></strong>
                                       </div>
                                    </div>
                                    <div class="summary-footer">
                        ...
                        <section class="panel panel-featured-left panel-featured-quartenary">
                           <div class="panel-body">
                              <div class="widget-summary">
                                 ...
                                 <div class="widget-summary-col">
                                    <div class="summary">
                                       <h4 class="title">Number Of E.C Officials</h4>
                                       <div class="info">
                                          <strong class="amount"><?php   $get_officials_number = mysqli_query($my_connect,"SELECT * FROM `reg_tbl_login` WHERE reg_user_status = '2'"); echo  mysqli_num_rows($get_officials_number);    ?></strong>
                                       </div>
                                    </div>
                                    <div class="summary-footer">
