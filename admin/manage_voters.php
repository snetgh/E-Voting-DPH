...
<head>
   ...
   <title>Voting | Manage Voters</title>
               ...
               <div class="col-md-12">
                  <section class="panel">
                     <header class="panel-heading">
                        ...
                        <h2 class="panel-title">Manage Voters</h2>
                     </header>
                     <div class="panel-body">
                        <div class="table-responsive" style="overflow-x: hidden!important">
                           <table class="table table-hover mb-none" id="datatable-default">
                              ...
                              <tbody>
                                 <?php
													$get_voters_data = mysqli_query($my_connect,"SELECT * FROM tbl_voters_list");
