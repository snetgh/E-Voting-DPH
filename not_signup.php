<?php
  ...
  require 'db/db.php';
   ...
   if (isset($_POST['btn_signup'])) {
    ...
    $my_insert_query = mysqli_query($my_conn,"INSERT INTO `login_tbl` (`user_id`, `user_name`, `user_password`, `user_timestamp`) VALUES (NULL, '$user_username', '$strong_pass', CURRENT_TIMESTAMP)");
	...
	<body>
		...
		<section class="body-sign">
			<div class="center-sign">
					...
					<div class="panel-body">
						<form method="post">
							...
							<div class="row" style="text-align: center;">
									...
									<button type="submit" name="btn_signup" class="btn btn-primary btn-block btn-lg visible-xs mt-lg">Sign Up </button>
				...
				<p class="text-center text-muted mt-md mb-md">&copy; Copyright <?php echo date('Y')  ?>. All rights reserved. Developed By Step Network .-- &nbsp; ( +233 &nbsp; 0245908362)</p>
			</div>
		</section>
		<!-- end: page -->
